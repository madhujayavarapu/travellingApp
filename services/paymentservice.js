...
var PaytmConfig = {
	mid: "ZeroIn32095935210106",
	key: "P1u&FL3%c&@4Kij&",
	website: "APPSTAGING"
}

var service = {
    generatechecksumpayment: generatechecksumpayment,
    verifychecksumpayment: verifychecksumpayment
}
module.exports = service;

function generatechecksumpayment(req,res,next){
  var params 						= {};
  ...
  params['CALLBACK_URL']		= 'http://localhost:'+port+'/tabs/home';
...
function verifychecksumpayment(req,res,next){
  var body = '';
